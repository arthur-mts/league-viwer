...
class MenuAut:
    def __init__(self, loop = True):
        ...
        self.root.geometry("900x650+220+0")
    ...
    def renderAutenticar(self):
        ...
        self.botaoAut = Button(self.container2, text="Autenticar", fg="Grey90", bg="Grey10",
                               ...
                               activeforeground="Grey90", width=20)
    ...
    def renderSalvarInvocador(self):
        ...
        self.botaoSalvar = Button(self.frameInv, text="Buscar", anchor=CENTER, fg="DarkOrange3", bg="Grey10",
                                  font=("Arial", "13", "bold"), bd=2, relief="solid", activebackground="Grey20",
                                  activeforeground="Grey90", width=15)
    ...
    def renderMenuLateral(self):
        ...
        self.boxBotoes.place(y=200, x=600)

        self.botao1 = Button(self.boxBotoes, text="Campeões mais jogados", bg="Grey10", fg="OliveDrab1", height=1,
                             width=25, font=("Arial", "13", "bold"), activebackground="Grey20",
                             activeforeground="Grey90", bd=3, relief="solid")
        self.botao1.grid(column=0, row=0, pady=15)
        
        self.botao2 = Button(self.boxBotoes, text="Estatísticas", bg="Grey10", fg="OliveDrab1", height=1, width=25,
        ...
        self.botao3 = Button(self.boxBotoes, text="Última partida", bg="Grey10", fg="OliveDrab1", height=1, width=25,
                             font=("Arial", "13", "bold"), activebackground="Grey20", activeforeground="Grey90", bd=3,
                             relief="solid")
        self.botao3.grid(column=0, row=2, pady=15)

        self.botao4 = Button(self.boxBotoes, text="Ver rank", bg="Grey10", fg="OliveDrab1", height=1, width=25,
                             font=("Arial", "13", "bold"), activebackground="Grey20", activeforeground="Grey90", bd=3,
                             relief="solid")
